...
import MyHtmlComponentLottie from './html6';
...
const YourComponent: React.FC = () => {
  ...
  const projects = [
    { id: '1', name: 'Quantum Computation', description: 'Description of Project 1', collaborativeComponent: MyHtmlComponentLottie },
